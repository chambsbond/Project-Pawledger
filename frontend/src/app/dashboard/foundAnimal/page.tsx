                    ...
                    <FormGroup>
                        <Stack padding={5} spacing={3}>
                            ...
                            <Stack direction="row" justifyContent="space-between">
                                <Typography fontWeight="bold">Does the animal have an animal collar with the owner's contact information?</Typography>
                                <Checkbox
                            ...
                            {!hasIdentifier &&
                                <Stack direction="row" justifyContent="space-between">
                                    <Typography fontWeight="bold">I have attempted communication with the owner and didn't make contact and the animal is chipped</Typography>
                                    <Checkbox
                                        checked={isChipped}
